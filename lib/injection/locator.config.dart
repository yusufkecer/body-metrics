...
import 'package:bodymetrics/data/cache/bmi_cache/user_metrics_cache.dart' as _i1049;
...
import 'package:bodymetrics/domain/repository/app_info_repository.dart' as _i728;
import 'package:bodymetrics/domain/repository/save_app_repository.dart' as _i395;
...
import 'package:bodymetrics/feature/gender/domain/repository/save_gender_repository.dart' as _i218;
import 'package:bodymetrics/feature/gender/domain/use_case/save_gender_use_case.dart' as _i708;
...
import 'package:bodymetrics/feature/home/domain/repository/home_user_repository.dart' as _i414;
import 'package:bodymetrics/feature/home/domain/repository/home_users_repository.dart' as _i41;
import 'package:bodymetrics/feature/home/domain/use_case/home_user_use_case.dart' as _i815;
import 'package:bodymetrics/feature/home/domain/use_case/home_users_use_case.dart' as _i539;
...
import 'package:bodymetrics/feature/onboard/presentation/cubit/onboard_cubit.dart' as _i578;
import 'package:bodymetrics/feature/splash/domain/repository/splash_app_repository.dart' as _i437;
import 'package:bodymetrics/feature/splash/domain/repository/splash_user_repository.dart' as _i288;
import 'package:bodymetrics/feature/splash/domain/use_case/splash_app_use_case.dart' as _i31;
import 'package:bodymetrics/feature/splash/domain/use_case/splash_user_use_case.dart' as _i193;
import 'package:bodymetrics/feature/user_general_info/cubit/user_general_info_cubit.dart' as _i722;
import 'package:bodymetrics/feature/user_general_info/domain/index.dart' as _i171;
import 'package:bodymetrics/feature/user_general_info/domain/repository/create_profile_repository.dart' as _i1073;
import 'package:bodymetrics/feature/user_general_info/domain/use_case/create_profile_use_case.dart' as _i470;
import 'package:bodymetrics/feature/weight_picker/domain/repository/save_weight_repository.dart' as _i406;
import 'package:bodymetrics/feature/weight_picker/domain/use_case/save_weight_use_case.dart' as _i986;
import 'package:bodymetrics/feature/weight_picker/presentation/cubit/weight_picker_cubit.dart' as _i978;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i174.GetIt init({
    ...
    gh.factory<_i406.SaveWeightRepository>(() => _i406.SaveWeightRepository(gh<_i101.UserMetricsCache>()));
    ...
    gh.factory<_i414.HomeUserRepository>(() => _i414.HomeUserRepository(gh<_i101.UserCache>()));
    gh.factory<_i1073.CreateProfileRepository>(() => _i1073.CreateProfileRepository(gh<_i981.UserCache>()));
    gh.factory<_i41.HomeUsersRepository>(() => _i41.HomeUsersRepository(gh<_i101.UserCache>()));
    gh.factory<_i288.SplashUserRepository>(() => _i288.SplashUserRepository(gh<_i101.UserCache>()));
    gh.factory<_i437.SplashAppRepository>(() => _i437.SplashAppRepository(
          gh<_i101.AppCache>(),
          gh<_i101.UserCache>(),
        ));
    gh.factory<_i470.CreateProfileUseCase>(() => _i470.CreateProfileUseCase(gh<_i1073.CreateProfileRepository>()));
    gh.factory<_i986.SaveWeightUseCase>(() => _i986.SaveWeightUseCase(gh<_i406.SaveWeightRepository>()));
    ...
    gh.factory<_i815.HomeUserUseCase>(() => _i815.HomeUserUseCase(gh<_i414.HomeUserRepository>()));
    gh.factory<_i85.OnboardRepository>(() => _i85.OnboardRepository(gh<_i101.AppCache>()));
    gh.factory<_i728.AppInfoRepository>(() => _i728.AppInfoRepository(gh<_i101.AppCache>()));
    gh.factory<_i395.SaveAppRepository>(() => _i395.SaveAppRepository(gh<_i101.AppCache>()));
    gh.factory<_i539.HomeUsersUseCase>(() => _i539.HomeUsersUseCase(gh<_i41.HomeUsersRepository>()));
    ...
    gh.factory<_i978.WeightPickerCubit>(() => _i978.WeightPickerCubit(
          gh<_i815.HomeUserUseCase>(),
          gh<_i986.SaveWeightUseCase>(),
        ));
    gh.factory<_i1014.UserCubit>(() => _i1014.UserCubit(gh<_i815.HomeUserUseCase>()));
    ...
    gh.factory<_i681.SaveHeightUseCase>(() => _i681.SaveHeightUseCase(gh<_i896.SaveHeightRepository>()));
