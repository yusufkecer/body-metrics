...
import 'package:bodymetrics/feature/home/domain/repository/home_users_repository.dart'
    as _i303;
import 'package:bodymetrics/feature/home/domain/use_case/home_user_use_case.dart'
    as _i255;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i174.GetIt init({
    ...
    gh.factory<_i1014.UserCubit>(
        () => _i1014.UserCubit(gh<_i243.UserUseCase>()));
    ...
    gh.factory<_i302.UserRepositoryImpl>(
        () => _i302.UserRepositoryImpl(gh<_i389.UserCache>()));
    gh.factory<_i303.HomeUsersRepository>(
        () => _i303.HomeUsersRepository(gh<_i101.UserCache>()));
    gh.factory<_i80.HomeUserRepository>(
        () => _i80.HomeUserRepository(gh<_i101.UserCache>()));
    ...
    gh.factory<_i219.HomeUsersUseCase>(
        () => _i219.HomeUsersUseCase(gh<_i303.HomeUsersRepository>()));
    ...
    gh.factory<_i255.HomeUserUseCase>(
        () => _i255.HomeUserUseCase(gh<_i80.HomeUserRepository>()));
